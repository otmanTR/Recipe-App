...
RSpec.describe 'RecipeFoods', type: :request do
  ...
  before(:each) do
    @user = User.create(name: 'User Name', role: 'admin', email: '123456@gmail.com', password: '123456')
    sign_in @user
    @recipe = Recipe.create(name: 'Recipe', description: 'Description', public: true,
                            preparation_time: '10', cooking_time: '10', user_id: @user.id)
    @food = Food.create(name: 'Food', user_id: @user.id, measurement_unit: 'KG', price: 10, quantity: 10)
